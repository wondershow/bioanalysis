...
**/
var SVGLongslider  = function (params) {
...
SVGLongslider.prototype.generate = function () {
...
SVGLongslider.prototype.addHLabel = function() {
...
**/
SVGLongslider.prototype.drawLeftHandle = function () {
...
SVGLongslider.prototype.drawUpperHandle = function () {
	...
	var evalStr = "var tmp_function1 = function(e){ \
			if( (typeof "+from_handle_id+"slider_on !== 'undefined')  && "+from_handle_id+"slider_on) { \
				...
				$('#" + from_handle_id + "').attr('transform','translate('+newTransformX+','+newTransformY+')'); \
				d3.select('#" + from_text_id + "').text( "+this.containerid+"_range_from ); \
				mainCanvas.updateChart('"+this.chartId +"','a', "+this.containerid+"_range_from ,"+this.containerid+"_range_to );	\
				}\
	}";
...
SVGLongslider.prototype.drawRightHandle = function () {
...
SVGLongslider.prototype.drawLowerHandle = function () {
...
SVGLongslider.prototype.genHorizontal = function() {
...
SVGLongslider.prototype.genVertical = function() {
	this.addVLabel()
	var path_str = "M" + this.barAnchorX + "," 
					+ this.barAnchorY + "H" 
					+ (this.barAnchorX + this.sliderWidth) 
...
SVGLongslider.prototype.addVLabel = function() {	
	//To add label
	var test = d3.select("#"+this.containerid).append("text")
